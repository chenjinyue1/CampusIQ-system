...
class ChatModelFactory(BaseModelFactory):
    ...
    def generator(self) -> Optional[Embeddings | BaseChatModel]:
        ...
        if llm_type == "OLLAMA":
            model_name = os.getenv("OLLAMA_CHAT_MODEL_NAME")
            ...
            model_name = os.getenv("ALIYUN_CHAT_MODEL_NAME")
...
class EmbedModelFactory(BaseModelFactory):
    ...
    def generator(self) -> Optional[Embeddings | BaseChatModel]:
        ...
        embed_type = os.getenv("EMBED_MODEL_TYPE").upper()

        if embed_type == "OLLAMA":
            model_name = os.getenv("OLLAMA_EMBED_MODEL_NAME")
            base_url = os.getenv("OLLAMA_BASE_URL")
            ...
            model_name = os.getenv("ALIYUN_EMBED_MODEL_NAME")
            api_key = os.getenv("ALIYUN_API_KEY")
...
class VisionModelFactory(BaseModelFactory):
    ...
    def generator(self) -> Optional[BaseChatModel]:
        ...
        if vision_type == "OLLAMA":
            model_name = os.getenv("VISION_OLLAMA_MODEL_NAME") or os.getenv("OLLAMA_CHAT_MODEL_NAME")
            base_url = os.getenv("OLLAMA_BASE_URL")
            ...
            model_name = os.getenv("VISION_ALIYUN_MODEL_NAME") or os.getenv("ALIYUN_CHAT_MODEL_NAME")
            api_key = os.getenv("ALIYUN_API_KEY")
            base_url = os.getenv("ALIYUN_BASE_URL")
