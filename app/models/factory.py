...
class DashScopeEmbeddingsWrapper(Embeddings):
    ...
    def __init__(self, model_name: str = "qwen3-embedding:4b", api_key: str = None):
        try:
            import dashscope
            self.dashscope = dashscope
            self.dashscope.api_key = api_key or os.getenv("ALIYUN_API_KEY")
...
class ChatModelFactory(BaseModelFactory):
    ...
    def generator(self) -> Embeddings | BaseChatModel | None:
        ...
        if llm_type == "OLLAMA":
            model_name = os.getenv("OLLAMA_CHAT_MODEL_NAME", os.getenv("OLLAMA_CHAT_MODEL_NAME"))
            ...
            model_name = os.getenv("ALIYUN_CHAT_MODEL_NAME", os.getenv("ALIYUN_CHAT_MODEL_NAME", "qwen3-max"))
...
class EmbedModelFactory(BaseModelFactory):
    ...
    def generator(self) -> Embeddings | BaseChatModel | None:
        ...
        if embed_type == "OLLAMA":
            model_name = os.getenv("OLLAMA_EMBED_MODEL_NAME", "qwen3-embedding:4b")
            base_url = os.getenv("OLLAMA_BASE_URL", "http://localhost:11434")
...
class VisionModelFactory(BaseModelFactory):
    ...
    def generator(self) -> BaseChatModel | None:
        ...
        vision_type = os.getenv("VISION_MODEL_TYPE", "").upper() or os.getenv("LLM_TYPE").upper()

        if vision_type == "OLLAMA":
            model_name = os.getenv("VISION_OLLAMA_MODEL_NAME") or os.getenv("OLLAMA_CHAT_MODEL_NAME") or "qwen-vl:7b"
            base_url = os.getenv("OLLAMA_BASE_URL", "http://localhost:11434")
            ...
            model_name = os.getenv("VISION_ALIYUN_MODEL_NAME") or os.getenv("ALIYUN_CHAT_MODEL_NAME") or "qwen3-max"
            api_key = os.getenv("ALIYUN_API_KEY")
            base_url = os.getenv("ALIYUN_BASE_URL")
